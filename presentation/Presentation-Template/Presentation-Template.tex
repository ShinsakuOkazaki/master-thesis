...
\begin{frame}[fragile]{Rust}
    ...
    \begin{itemize}
        ...
        \item \blue{Rust is a relatively new language.}
...
\begin{frame}[t, fragile]{Experimental Setting}
    ...
    \textbf{Other Setting}
    \begin{itemize}
        \item Run 5 times for each experiment
        \item Take average of runtime
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Experiment 2: Assessment of different reference methods in Rust}
    ...
    \begin{figure}[hp]
        \centering
        \begin{center}
                \includegraphics[width=0.7\textwidth]{images/rust_droptime_borring_rc.eps}
                \captionsetup{labelformat=empty}
                % \caption{\textbf{}}
        \end{center}
    \end{figure}
