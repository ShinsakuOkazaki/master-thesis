...
\title{ An Experimental Study of Memory Management with Rust Programming for Big Data Processing}
...
\reader{Second}{Eugene Pinsky, PhD}{Associate Professor of Computer Science}
\reader{Third}{Reza Rawassizadeh, PhD}{Assistant Professor of Computer Sicence}

% The Major Professor is the same as the first reader, but must be
% specified again for the abstract page. Up to 4 Major Professors
% (advisors) can be defined. 
\numadvisors=2
\majorprof{Kia Teymourian, PhD}{{Assistant Professor of Computer Sicence}}
...
\begin{center}
  \begin{tabular}{lll}
    ...
    Rc   & \dotfill & Reference counting \\
    Arc  & \dotfill & Atomic reference counting\\
  \end{tabular}
\end{center}
\cleardoublepage
