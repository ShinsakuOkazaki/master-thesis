...
\section{Experiment of Memory Allocation (Manual Way)}
\label{sec:history}

\begin{figure}[htb]
    \includegraphics[width=15cm]{java_arraylist_manual.eps}
    \caption{Memory allocation of ArrayList in Java version2}
    \label{fig:Sampling}
\end{figure}

\begin{figure}[htb]
    \includegraphics[width=15cm]{rust_vector_manual.eps}
    \caption{Memory allocation of Vector in Rust version2}
    \label{fig:Sampling}
\end{figure}