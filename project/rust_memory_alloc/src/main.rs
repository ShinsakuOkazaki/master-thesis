...
fn main() {
    ...
    let elementtype: i32 = args[3].parse().unwrap();
    vector_addition(size, initialization, elementtype)
...
fn vector_initialization(size: usize, initialization: bool) {
    let mut vector;
    if initialization {
...
fn get_elementsVec(size: usize, elementtype: i32) -> std::vec::Vec<T> {
...
fn element_integer(size: usize) -> std::vec::Vec<T> {
    let mut elements = Vec::new();
    for e in 0..size {
...
fn element_string(size: usize) -> std::vec::Vec<T> {
    let mut elements = Vec::new();
    for _i in 0..size {
...
fn elements_charArr(size: usize) -> std::vec::Vec<T> {
    let mut elements = Vec::new();
    for _i in 0..size {
...
fn elements_object(size: usize) -> std::vec::Vec<T> {
    let mut elements = Vec::new();
