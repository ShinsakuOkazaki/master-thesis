...
line_sizes=(1000 2000 3000 4000)
order_sizes=(1000 2000 3000 4000)
customer_sizes=(1000 2000 3000 4000)

line_file=../data/tables_scale_0.1/lineitem.tbl
order_file=../data/tables_scale_0.1/orders.tbl
customer_file=../data/tables_scale_0.1/customer.tbl
