...
\begin{frame}[fragile]{Problem Description}
    ...
    \begin{itemize}
        ...
        \item \blue{High Complex Nested Objects vs. Simple Objects/Primitive Types}
        \item \blue{Different Rust Memory Management Strategies: Ownership vs. Borrowing vs. Slicing}
